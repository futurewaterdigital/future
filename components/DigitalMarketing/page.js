...
export default function page() {
  return (
    <div className="z-20 bg-[#020D17] lg:pt-40">
      ...
      <div className="z-0 mx-auto grid gap-16 px-4 py-12 md:grid-cols-2 lg:w-10/12 lg:grid-cols-3">
        {DigitalMarketing.map((items, index) => (
          <div className="group relative lg:left-[20px]" key={index}>
            ...
            <p className="relative mt-4 rounded-lg p-6 text-[14px] text-white transition-all group-hover:bg-gray-700 lg:right-[25px] lg:max-w-sm lg:text-lg">
              {items.description}
            </p>
          </div>
        ))}
